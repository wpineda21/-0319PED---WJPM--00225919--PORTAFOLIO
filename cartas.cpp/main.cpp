...
int main(){
    ...
    for (int i = 0; i < 5; i++) {
        ...
        }else if(cartaJug1.numero==1 || cartaJug1.numero > cartaJug2.numero 
        && !cartaJug2.numero==1 || !cartaJug2.numero>cartaJug1.numero 
        && !cartaJug2.numero==cartaJug1.numero){
...
void mostrarCarta(Carta unaCarta){
    ...
    switch (unaCarta.palo){
        ...
        case Corazones: cout << "corazones"<<" Rojo  "; break;
        case Diamantes: cout << "diamantes"<<" Rojo  "; break;
        case Treboles: cout << "treboles"<<" Negro  "; break;
        case Picas: cout << "picas"<< " Negro "; break;
    }
    cout << endl;
}
